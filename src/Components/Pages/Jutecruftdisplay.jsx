...
const Jutecruftdisplay = ({ juteprod }) => {

    const { name, catselect, madeof, quantity, photo, price, descripion } = juteprod;
...
Jutecruftdisplay.propTypes = {
    juteprod: PropTypes.object
}
export default Jutecruftdisplay;